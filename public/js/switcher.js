...
jQuery(document).ready(function () {
  ...
  if (jQuery.cookie) {
    if (!jQuery.isEmptyObject(jQuery.cookie())) {
      deleteAllCookiesHTML =
        '<span class="rt-icon2-delete-outline" data-toggle="tooltip" data-placement="top" title="Clear All Styles (Page will be reloaded)"></span>';
    }
  }
  ...
  for (var i = 0; i < 12; i++) {
    switcherHTML += "<li>";
    switcherHTML +=
      '<a href="#" class="pattern' + i + '" data-pattern="pattern' + i + '">';
    switcherHTML +=
      '<img src="img/pattern' +
      i +
      '.png" alt="" width="40" height="40" title="pattern' +
      i +
      '">';
    switcherHTML += "</a>";
    switcherHTML += "</li>";
  ...
  jQuery('#switcher span[class="rt-icon2-delete-outline"]').on(
    "click",
    function () {
